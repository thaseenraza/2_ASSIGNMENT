...
# 'x': 120, 'y': 121, 'z': 122}
my_dict = {}
n = int(input("Enter the range for ASCII Values :"))
if n<97:
    print("The ASCII Values starts from 97 onwards :",n)
elif n <=123:
    for i in range(97, n):
      my_dict[chr(i)] = i
    print(my_dict)
else:
    print("The Entered Range of ASCII Values are out of its range :",n)
